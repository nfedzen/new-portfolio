...
export default function Work() {
  ...
  return (
    <div
      ...
      id="mywork"
    >
      <h1 className="text-5xl font-dosis font-bold mt-10">{content.work.title}</h1>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center w-11/12 ">
        <LazyLoadImage
          ...
          alt="phone prototype"
          className="m-10 transtion duration-2000 ease-in-out z-10  md:w-3/5 w-4/5 rounded-lg"
        />
        <div
